...
6 - A list of html files will be displayed on the left side. Do Ctrl+Clink on the links to open them in your webrowser. You can also open the html files localy if you want (i suggest using w3m if you want to open that from the terminal)<br>
7 - Enjoy<br>
